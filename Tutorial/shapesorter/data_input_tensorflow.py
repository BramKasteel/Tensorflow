# -*- coding: utf-8 -*-
"""
Created on Tue Jun 13 13:01:24 2017

@author: bram
tutorial from:
https://agray3.github.io/2016/11/29/Demystifying-Data-Input-to-TensorFlow-for-Deep-Learning.html

Learns us how to create Tensorflow input (?of the DataSet class (hopefully))
"""

#We will use the plotting library Matplotlib (http://matplotlib.org/users/installing.html)
#Already have it, from Anaconda

""" Create folders to put data in (Not used to unix yet, so leave it as is)
...
###############################################################################
#Step one: generate the images of squares and triangles using matplotlib:
###############################################################################
